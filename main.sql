...
create database bus;
  ...
  CREATE TABLE IF NOT EXISTS BookingDetails (
    ...
    status int(4) COMMENT 'DONE 1 | Pending 0 | Cancelled -1',
  ...
  -- 16. For cancellation of bookings
  update BookingDetails set status=-1 where datediff(CURDATE(),bookingDate)>2;
